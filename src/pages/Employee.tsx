  ...
  return (
    <div className="bg-admin">
      ...
      <div className="flex flex-col items-center ">
        ...
        <button className="bg-red-600 text-white active:bg-red-600 font-bold text-sm px-10 py-3 rounded shadow hover:bg-red-400 outline-none focus:outline-none mr-1 mb-1" type="button" style={{ transition: "all .15s ease" }}>
            Cancel
        </button>
          <Modal/>
